...
public interface CacheService<K, V> {
     ...
     * @param value 值
     */
    void addMap(K key, K field, V value);
     ...
     * @return 是否成功
     */
    Boolean addZSet(K key, double score, V value);
     ...
     * @param e   最大
     */
    void removeZSetRangeByScore(K key, double s, double e);
     ...
     * @param key2 键2
     */
    void setZSetUnionAndStore(K key, K key1, K key2);
     ...
     * @return 有序集合
     */
    Set<V> getZSetRange(K key, long start, long end);
     ...
     * @return 有序集合
     */
    Set<V> getZSetReverseRange(K key);
